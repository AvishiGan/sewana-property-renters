...
<div class="container-fluid p-5 bg-primary text-white text-center">
  <h1>Welcome! | <span class="badge bg-danger">Supervisor Dashboard</span> </h1>
   
</div>
<br>
<ul class="nav justify-content-center">
    <li class="nav-item" style="padding-right: 6px;">
      <button  class="btn btn-outline-primary"; onclick="window.location.href='assistantmsgrequest.php'";> Request Assistant Details</button>
    </li>
    <li class="nav-item" style="padding-right: 6px;">
    ...
    <li class="nav-item" style="padding-right: 6px;">
    <button  class="btn btn-outline-primary"; onclick="window.location.href='propertymsgrequest.php'";> Requests Property Details</button>
    </li>
